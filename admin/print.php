...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Nanekar's Accommodation</p>
				<p>1 Paddington, Edge Hill,<br>Liverpool L7 3RG,<br>United Kingdom.</p>
				<p>(+91) 9130132118</p>
			</address>
			<span><img alt="" src="assets/img/n.jpg"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- omkar820@gmail.com || Web :- www.nanekarsacc.com || Phone :- +91 9130132118 </p>
			</div>
		</aside>
	</body>
</html>
